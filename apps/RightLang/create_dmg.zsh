...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🔨 Building and Packaging then.app v0.2.2"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
then 0.2.2 - Thai/English Text Conversion Service
================================================
...
# Create DMG
DMG_OUTPUT="$OUTPUT_DIR/then-0.2.2.dmg"
hdiutil create -volname "then 0.2.2" \
  -srcfolder "$DMG_BUILD" \
  -ov -format UDZO \
  "$DMG_OUTPUT"
...
if [[ -d "/Volumes/then 0.2.2/then.app" ]]; then
  echo "  ✅ DMG contains then.app"

  if codesign -v "/Volumes/then 0.2.2/then.app" 2>&1; then
    echo "  ✅ Signature valid"
  else
    echo "  ⚠️  Signature verification failed"
  fi

  if [[ -L "/Volumes/then 0.2.2/Applications" ]]; then
    echo "  ✅ Applications symlink present"
  fi

  if [[ -f "/Volumes/then 0.2.2/INSTALL.txt" ]]; then
...
hdiutil detach "/Volumes/then 0.2.2" -quiet 2>/dev/null || true
