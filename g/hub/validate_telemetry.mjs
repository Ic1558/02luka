...
try {
  ...
  const schema = JSON.parse(fs.readFileSync('./g/schemas/telemetry_v2.schema.json','utf8'));
  const data   = JSON.parse(fs.readFileSync('./hub/system_telemetry_v2.json','utf8'));
