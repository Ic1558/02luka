...
1. ⚠️ **Clarify routing rules** - Make PROTOCOL authoritative, GG_CONTRACT references it

2. ⚠️ **Consolidate Codex write mechanisms** - Single "Boss Override" with clear precedence

3. ⚠️ **Add explicit fallback decision tree** - Document LPE vs Emergency Codex/Liam priority

### Long-term (S1-S3, R1-R3)

1. 📝 **Improve terminology consistency** - Create glossary, use preferred terms

2. 📝 **Add cross-references** - Include file paths and versions

3. 📝 **Monitor emergency mode usage** - Track frequency, require reviews
