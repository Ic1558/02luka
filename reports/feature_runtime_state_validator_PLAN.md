...
- Emits Markdown + JSONL reports to reports/system/launchagents_runtime/
...
### T2 — Report writer
- Create directory: reports/system/launchagents_runtime/
- Filenames:
...
- Read latest JSONL under reports/system/launchagents_runtime/
- Return array of agent runtime entries

### T5 — MLS entry
- Append to knowledge/mls_lessons.jsonl:
